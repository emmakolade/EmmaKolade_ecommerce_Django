...
urlpatterns = [
	...
	path('reset_password_sent', auth_views.PasswordResetDoneView.as_view(template_name="store/resetPasswordSent.html"), name="password_reset_done"),

	path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name="store/resetPasswordForm.html"), name="password_reset_confirm"),

	path('reset_password', auth_views.PasswordResetCompleteView.as_view(template_name="store/resetPasswordDone.html"), name="password_reset_complete"),
]